...
def train_evaluate_register(preprocessing_run_id, C=1.0):
    """
    Loads preprocessed data, trains a model, evaluates it,
    and registers the model in the MLflow Model Registry
    if it meets both performance thresholds.
    """
    ...
    with mlflow.start_run(run_name=f"logistic_regression_C_{C}"):
        ...
        # Probability of class 1 for ROC-AUC
